...
<!-- slider section -->
  <marquee><h5><%= (String)request.getAttribute("anote")%></h5></marquee>
          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <div class="img-box">
                    <img src="images/logo.jpg" alt="" style="border-radius: 120px;">
                  </div>
                </div>
                <div class="col-md-8">
 ...
 <!-- discount section -->
          ...
          <div class="item">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <div class="text">
                  <h6>
                  <span style=" color: red;"> 10% off </span> 5 kg
                  </h6>
                  <h6 class="price">
                    <span>
                      &#8377;
            ...
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <div class="text">
                  <h6>
                    <span style=" color: red;"> 10% off </span> 15 kg
                  </h6>
                  <h6 class="price">
                    <span>
                      &#8377;
          ...
          <div class="item">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <div class="text">
                  <h6>
                   <span style=" color: red;"> 10% off </span>10 kg
                  </h6>
                  <h6 class="price">
                    <span>
                      &#8377;
  ...
  <section class="about_section layout_padding">
    <div class="container">
      ...
      <div class="img-box">
        <img src="images/about1.jpg" alt="" style="border-radius: 30px;">
      </div>
      <div class="detail-box">
        <p>
          ...
          <div class="form_contaier">
            <form action="Contact" method="post">
              <div class="form-group">
                <label for="rcnm">Name</label>
                <input type="text" class="form-control" name="nm" id="nm">
              </div>
              <div class="form-group">
                <label for="rcmob">Phone Number</label>
                <input type="text" class="form-control" name="mob" id="mob">
              </div>
              
              <div class="form-group ">
                <label for="rcoct">Select Oxygen Cylinder Type</label>
                <select name="ft" id="ft" class="form-control">
                  <option selected>Cylinder A-5kg</option>
                  <option >Cylinder B-15kg</option>
                  <option >Cylinder C-10kg</option>
                </select>
              </div>
              <div class="form-group">
                <label for="rcms">Message</label>
                <input type="text" class="form-control" name="feed" id="feed">
              </div>
              <button type="submit" class="" onfocus="index.jsp">Send</button>
            </form>
          </div>
        </div>
        <div class="col-md-7">
